...
#ifdef ZIC_ENABLE_GOTO_OVERLOADING
#define HANDLE_SYS(...) GET_GOTO_MACRO(__VA_ARGS__, HANDLE_SYS_GOTO, HANDLE_SYS_FINAL)(__VA_ARGS__)
#else
...
#define UNWRAP_ERR(...) GET_GOTO_MACRO(__VA_ARGS__, UNWRAP_ERR_GOTO, UNWRAP_ERR_FINAL)(__VA_ARGS__)

#define UNWRAP(...) GET_GOTO_MACRO(__VA_ARGS__, UNWRAP_GOTO, UNWRAP_FINAL)(__VA_ARGS__)
...
#define RES_UNWRAP_ERR(...) RES_GET_GOTO_MACRO(__VA_ARGS__, RES_UNWRAP_ERR_GOTO, RES_UNWRAP_ERR_FINAL)(__VA_ARGS__)

#define RES_UNWRAP(...) GET_GOTO_MACRO(__VA_ARGS__, RES_UNWRAP_GOTO, RES_UNWRAP_FINAL)(__VA_ARGS__)
...
#define UNWRAP_NEG(...) GET_GOTO_MACRO(__VA_ARGS__, UNWRAP_NEG_GOTO, UNWRAP_NEG_FINAL)(__VA_ARGS__)

#define UNWRAP_NSYS(...) UNWRAP_NEG(__VA_ARGS__)

#define UNWRAP_NERR(...) GET_GOTO_MACRO(__VA_ARGS__, UNWRAP_NERR_GOTO, UNWRAP_NERR_FINAL)(__VA_ARGS__)
...
#define RES_UNWRAP_NEG(...) GET_GOTO_MACRO(__VA_ARGS__, RES_UNWRAP_NEG_GOTO, RES_UNWRAP_NEG_FINAL)(__VA_ARGS__)

#define RES_UNWRAP_NSYS(...) RES_UNWRAP_NEG(__VA_ARGS__)

#define RES_UNWRAP_NERR(...) GET_GOTO_MACRO(__VA_ARGS__, RES_UNWRAP_NERR_GOTO, RES_UNWRAP_NERR_FINAL)(__VA_ARGS__)
...
#define UNWRAP_PTR(...) GET_GOTO_MACRO(__VA_ARGS__, UNWRAP_PTR_GOTO, UNWRAP_PTR_FINAL)(__VA_ARGS__)

#define UNWRAP_PTR_SYS(...) UNWRAP_PTR(__VA_ARGS__)

#define UNWRAP_PTR_ERR(...) GET_3ARG_MACRO(__VA_ARGS__, UNWRAP_PTR_ERR_GOTO, UNWRAP_PTR_ERR_FINAL)(__VA_ARGS__)
